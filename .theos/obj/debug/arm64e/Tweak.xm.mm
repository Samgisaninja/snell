...
@class UIAlertController; @class _UIInterfaceActionGroupHeaderScrollView; @class _UIDimmingKnockoutBackdropView; @class SpringBoard; @class _UIAlertControlleriOSActionSheetCancelBackgroundView; @class _UIAlertControllerActionView; @class UIViewController; @class _UIInterfaceActionVibrantSeparatorView; 
...
static __attribute__((constructor)) void _logosLocalCtor_6f9d9fb9(int __unused argc, char __unused **argv, char __unused **envp) {
